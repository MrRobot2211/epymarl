...
class EpisodeBatch:
    def __init__(
        ...
        self.groups = groups
        # barch_size is only important when running the environment in parallel. It is the number of environments being ran this way
        self.batch_size = batch_size
        # max_seq_length to store
        ...
        if data is not None:
            ...
            self.data = SN()
            # data trasnsition data will hold the names of the attributes for a transition batch
            self.data.transition_data = {}
            # data trasnsition data will hold the names of the episode end(?)(batch
    ...
    def _setup_data(self, scheme, groups, batch_size, max_seq_length, preprocess):
        ...
        for field_key, field_info in scheme.items():
            ...
            # this episode_const is not defined anywhere, and not attached to the scheme it seems unused
    ...
    def update(self, data, bs=slice(None), ts=slice(None), mark_filled=True):
        # when we recieve a time the slace will be a t:t+1
